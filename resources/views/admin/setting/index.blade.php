          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              @if($setting->about_photo)
                <div class="mb-2"><img src="{{ asset('storage/' . $setting->about_photo) }}" width="80" class="rounded"></div>
              @endif
          ...
          <div class="card-body">
            <h4 class="card-title">Website Settings</h4>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="email" class="form-control" name="fb_url" value="{{$setting->fb_url}}" placeholder="your@gmail.com" required/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">CV File</label>
                    <div class="col-sm-9">
                      @if($setting->cv_url)
                        <div class="mb-2"><a href="{{ asset('storage/' . $setting->cv_url) }}" target="_blank">Current CV</a></div>
                      @endif
